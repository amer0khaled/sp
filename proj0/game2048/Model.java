...
public class Model extends Observable {
    ...
    public boolean tilt(Side side) {
        ...
        * */
        ...
        /*loop from the top left tile to bottom tile for each column
        * by fixing the column and decreasing the row till we
        * reach the bottom of the grid.
        * we will do this operation in each column*/
